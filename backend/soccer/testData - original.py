...
def storeTeam ():
	import json
	sql = f"SELECT team_id,team_name,team_name_odd,img_src,league_id from team_list where team_id > 1887";
	mycursor.execute(sql)
	myresult = mycursor.fetchall()
...
def storeSeason():
	...
	for result in myresult:
		...
		print(PARAMS)
		r = requests.post('http://localhost:8000/api/StoreSeasonOtherDataSource',data=json.dumps(PARAMS))
		print(r)
		print('--------------------')
def storeSeasonMatchPlan():
	import json
	sql = f"SELECT * from season_match_plan_old where match_id > 58864";
	mycursor.execute(sql)
	myresult = mycursor.fetchall()
	...
	for result in myresult:
		...
		# print(data)
		r = requests.post('http://localhost:8000/api/StoreSeasonMatchPlanOtherDataSource',data=data)
		print(r)
		print('--------------------')
def storeMatchTeamPlayerInfo():
	import json
	sql = f"SELECT * from match_team_player_info";
	mycursor.execute(sql)
	myresult = mycursor.fetchall()
	...
	# 	data =json.dumps(PARAMS)
	# 	# print(data)
	# 	r = requests.post('http://sportsbetting.myvtd.site:8642/api/StoreMatchTeamPlayerInfoOtherDataSource',data=data)
	# 	print(r)
	# 	print('--------------------')
	return myresult 
...
def storePlayerCareer():
	import json
	sql = f"SELECT * from player_career where id > 24886";
	mycursor.execute(sql)
	myresult = mycursor.fetchall()
...
def storePlayerList():
	import json
	sql = f"SELECT * from playerlist where player_id > 56195";
	mycursor.execute(sql)
	myresult = mycursor.fetchall()
...
def storeSeasonLeagueTeamInfo():
	...
	for result in myresult:
		...
		data =json.dumps(PARAMS)
		# print(data)
		r = requests.post('http://localhost:8000/api/StoreSeasonLeagueTeamInfoOtherDataSource',data=data)
		print(r)
		print('--------------------') 

def main():
	# storeSeasonLeagueTeamInfo()
	getTeamImage('Hapoel Hadera')
	# storePlayerCareer()
