...
def switch_season(argument):
	...
	sql = f'SELECT season_id FROM season WHERE season_title = "{argument}"'
	print(sql)
...
def doing_scraping_match_plan(season=None , league=None, firstMatch = None, lastMatch = None, newInsertFlag = True ):
...
def main():
	...
	doing_scraping_match_plan("2019-2020","aut-bundesliga")			# maximum 132 - 6 * 22
	doing_scraping_match_plan("2018-2019","aut-bundesliga")			# maximum 132 - 6 * 22
	doing_scraping_match_plan("2017-2018","aut-bundesliga")	
	...
	# doing_scraping_match_plan("2010-2011","srb-super-liga")
